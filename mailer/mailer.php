...
if ($_POST) { // если передан массив POST
    ...
    // подготовим массив ответа
    $json = array();
    if (!$name or !$phone1 or !$phone2 or !$phone3) { // если хоть одно поле оказалось пустым
    ...
    $emailgo->from_email = 'from'; // от кого
    $emailgo->from_name = 'From Name';
    $emailgo->to_email = $email; // кому
    $emailgo->to_name = $name;
    $emailgo->subject = $subject; // тема
    $emailgo->body = $phone1 . $phone2 . $phone3 . $name; // сообщение
